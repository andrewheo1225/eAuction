	...
	<form action="SearchAuctionClothingType.jsp">
	  	<select name="ClothingType">
	    	...
	    	<option value="Shirt">Shirt</option>
	  		...
	  		<table>
				<tr>    
					<td>Minimum Price</td><td><input type="number"  min = "0" value = "0" step= "0.01" name="minPrice"></td>
				</tr>
				<tr>
					<td>Maximum Price</td><td><input type="number" min = "0" value = "0" step= "0.01" name="maxPrice"></td>
				</tr>
			</table>
